 ...
 */
public abstract class ObjectiveCppLibraryElement extends ObjectiveCppSourceElement {
     ...
     */
    public ObjectiveCppLibraryElement asLib() {
        final ObjectiveCppLibraryElement delegate = this;
