...
public abstract class GradlePluginDevelopmentTestSuiteDependenciesTester {
    ...
    @Nested
    class PluginUnderTestDependencyBucketTest extends DependencyBucketTester {
        @Override
        public GradleRunner runner() {
            return GradlePluginDevelopmentTestSuiteDependenciesTester.this.runner();
        }
        ...
        @Override
        public ExpressionBuilder<?> bucketDsl() {
            return testSuiteDsl().dot("dependencies.pluginUnderTest");
        }
        ...
        void hasDescription() {
            ...
            buildFile().append(groovyDsl(
                    "tasks.register('verify') {",
                    "  doLast {",
                    "    assert bucketUnderTest.asConfiguration.get().description == \"Plugin under test for ${testSuiteUnderTest.sourceSet.get()}.\"",
                    "  }",
                    "}"
            ));
