...
//
//class KotlinBasicGradlePlugin extends SourceElement implements GradlePluginElement {
//    final String pluginId = "com.example.hello"
//    final List<SourceFile> files = Collections.singletonList(sourceFile('kotlin', 'com/example/BasicPlugin.kt', """package com.example
