 ...
 *
 * @see GradleBuildTask#getOutcome()
 */
public enum GradleTaskOutcome {
    /**
    ...
    GradleTaskOutcome(boolean skipped, @Nullable String message) {
    ...
    static GradleTaskOutcome of(@Nullable String value) {
